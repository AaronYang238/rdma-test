...
| [06-selective-signaling](06-selective-signaling/) | 选择性 signaling 吞吐对比（阶段三） | `ibv_post_send`, `ibv_poll_cq` | ✅ |
| [07-srq](07-srq/) | SRQ 多 QP 共享接收队列（阶段四） | `ibv_create_srq`, `rdma_create_qp` | ✅ |
| [08-rpc](08-rpc/) | 极简请求/响应 RPC + 延迟基准（阶段七） | `post_send/recv` | ✅ |

> 01–05 配套入门主线（CLAUDE.md 第 1–8 节）；06–08 把进阶阶段（三/四/七）的
> 关键优化做成可动手运行的对比实验。
